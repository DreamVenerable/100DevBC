...
function ageCheck(){
    ...
    if (age < 16){
        document.querySelector('p').innerText = 'You can not drive'
            ...
            document.querySelector('p').innerText = 'You can not hate from outside the club, because you can\'t even get in'
        }   else if (age < 21) {
                document.querySelector('p').innerText = 'You can not drink'
                    ...
                    document.querySelector('p').innerText = 'You can not rent fancy cars affordably'
                            ...
                            document.querySelector('p').innerText = 'You have nothing to look forward to...only the inevitable death'
                        }
